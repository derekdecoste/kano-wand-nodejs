...
class GestureSpells {
  ...
  loadModel(load) { // temporarily getting from github bc node-fetch requires https?
    this.loaded = tf.loadLayersModel('https://raw.githubusercontent.com/derekdecoste/kano-wand-nodejs/master/model/spelling.json');
  }
